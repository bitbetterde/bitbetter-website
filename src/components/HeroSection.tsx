  ...
  return (
    <>
      <div className='flex flex-col items-start pt-[18.625rem] pb-24 lg:py-32 bg-bb-grey-200 px-5 lg:px-0 col-span-1 lg:col-span-5 lg:col-start-2'>
        <h1 className='text-black font-grotesk font-medium text-[1.75rem] lg:text-5xl mt-7 lg:leading-tight'>
          {title}
        </h1>
      ...
      <div className='relative lg:pt-24 w-full overflow-visible bg-bb-grey-200 col-span-1 lg:col-start-8 lg:col-span-6'>
        <div className={'lg:absolute h-[64vw] lg:h-[42rem] w-full overflow-hidden'}>
          <picture>
      ...
      <BbBracket className='text-transparent stroke-black -rotate-[10deg] scale-[140%] absolute w-72 -top-32 lg:top-8 -right-8 stroke-[0.5] z-20' />
    </>
  )
}
