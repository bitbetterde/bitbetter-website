...
image:
  ...
  alt: Eine Illustration von einem Elefanten, der mit den Logos von großen LLM-Anbietern beklebt ist. Der Elefant ist in einem Raum, der mit vier Software-Entwickler:innen gefüllt ist, die auf ihre Laptops starren. Das Bild wurde mit ChatGPT generiert.
...
Wie so oft vermitteln soziale Medien in diesem Bereich oft nur die Extrempositionen: Einerseits gibt es eine große Gruppe von Menschen, die KI und LLMs pauschal ablehnen und verteufeln. Deren Gründe sind zu großen Teilen absolut valide: Der ökologische Fußabdruck beim Trainieren von LLMs ist absurd, und KI-Rechenzentren zwingen den Hardware-Markt dauerhaft in die Knie. Durch die Zentralisierung und Monopolisierung der KI-Infrastruktur bei sehr wenigen, amerikanischen Tech-Firmen ergeben sich gefährliche, politische Abhängigkeiten. Die Beschaffung von Trainingsdaten für LLM wirft Moral und Urheberrecht komplett über Bord. Die Gefahr von Missbrauch und Desinformation ist immens und Open-Source-Maintainer werden durch LLM-basierte Code-Einreichungen massiv belastet.
