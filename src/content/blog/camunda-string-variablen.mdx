---
title: Warum Strings in Camunda nicht verwendet werden sollten
image:
  url: /images/blog/camunda/camunda-title.png
  alt: The Astro logo with the word One.
subtitle: Es ist schwierig 
teaser: "Ganz wie wir es mögen: Eine tolle Idee, ein tolles Team und dazu auch noch Open Source. Für unseren Kunden regenholz haben wir in der zweiten Jahreshälfte 2023 ein modernes Frontend für parametrische Open-Source-Möbel gebaut."
date: 2024-01-01
authors:
  - fabian
---
...
![](https://docs.camunda.org/manual/7.20/user-guide/process-engine/img/variables-1.png)
...
![](/images/blog/camunda/camunda-expression-field.png)
...
![](/images/blog/camunda/camunda-expression-getter.png)
